...
public class RecyclerViewCursorAdapter extends RecyclerView.Adapter<RecyclerViewCursorAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(ContactViewHolder holder, int position) {
        ...
        if (currentContact != null) {
            ...
            holder.contactAgeView.setText(currentContact.getAge());
        } else {
